...
const connectionString = 
    process.env.MONGODB_URI || 'mongodb://127.0.0.1:27017/socialMediaDB'; // 'socialMediaDB' database with this name does not already exist, it will be created automatically when the connection is established for the first time.
